...
"
" History:
"   2010-06-09 - Made background transparent. Set only background on visual mode. Made
"                selection lighter. Use only background color for diffs. No background
...
hi Visual         ctermfg=NONE  ctermbg=240                  guifg=#005f87  guibg=#afd7ff
hi VIsualNOS      ctermfg=24    ctermbg=153                  guifg=#005f87  guibg=#afd7ff
hi LineNr         ctermfg=248   ctermbg=NONE                 guifg=#a8a8a8  guibg=#080808
...
" Diff
hi diffAdd                      ctermbg=22                   guifg=#afd787
hi diffDelete                   ctermbg=52                   guifg=#d78787
hi diffChange                   ctermbg=17                   guifg=#000000  guibg=#afd7af
hi diffText                     ctermbg=20    cterm=bold     guifg=#000000  guibg=#949494
